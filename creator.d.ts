...
declare module cc {	
	...
	*/
	...
	It modifies the opacity from the currentWupin value to a custom one.
	!#zh 修改透明度到指定值。
	...
	*/
	...
	/** !#en Tints a Node that implements the cc.NodeRGB protocol from currentWupin tint to a custom one.
	!#zh 修改颜色到指定值。
	@param red 0-255
	@param green 0-255
	@param blue 0-255
	...
	*/
	...
	/** !#en
	Tints a Node that implements the cc.NodeRGB protocol from currentWupin tint to a custom one.
	...
	*/
	...
	/** !#en cc.winSize is the alias object for the size of the currentWupin game window.
	...
	*/
	...
	export enum DebugMode {		
		...
		*/
		...
		/** !#en Set currentWupin time
		!#zh 设置当前的音频时间。
		@param audioID audio id.
		@param sec currentWupin time.
	...
	export enum WrapMode {		
		...
		*/
		...
		wrapMode : WrapMode;		
		/** !#en The currentWupin time of this animation in seconds.
		!#zh 动画当前的时间，秒。 */
		time : number;	
	}		
		/** !#en
		...
		*/
		...
		The new scene will be launched at the end of the currentWupin frame.
		!#zh 运行指定场景。
		@param scene The need run scene.
		@param onBeforeLoadScene The function invoked at the scene before loading.
		@param onLaunched The function invoked at the scene after launch. 
		...
		*/
		...
		/** !#en Resume game logic execution after pause, if the currentWupin scene is not paused, nothing will happen.
		...
		*/
		...
		/** !#en Returns currentWupin logic Scene.
		!#zh 获取当前逻辑场景。
		...
		*/
		...
		canvas : any;		
		/** !#en
		The currentWupin game configuration, including:<br/>
		1. debugMode<br/>
		...
		6. scenes<br/>
		     "scenes" include available scenes in the currentWupin bundle.<br/>
		<br/>
		...
		*/
		...
		which consists of the currentWupin pose's bone SRT, slot colors, and which slot attachments are visible. <br/>
		...
		/** !#en The name of currentWupin armature.
		!#zh 当前的 Armature 名称。 */
		armatureName : string;		
		/** !#en The name of currentWupin playing animation.
		!#zh 当前播放的动画名称。 */
		...
		*/
		...
		/** !#en
		Get the currentWupin armature object of the ArmatureDisplay.
		!#zh
		...
		*/
		...
		/** !#en The currentWupin available size in the pool
		!#zh 获取当前缓冲池的可用对象数量 
		*/
		size() : void;		
		...
		*/
		...
		/** !#en
		Samples animations at the currentWupin state.<br/>
		...
		*/
		...
		instance : Canvas;		
		/** !#en The desigin resolution for currentWupin scene.
		!#zh 当前场景设计分辨率。 */
		...
		*/
		...
		/** !#en Returns currentWupin page index
		!#zh 返回当前页面索引 
		*/
		getCurrentPageIndex() : number;		
		/** !#en Set currentWupin page index
		!#zh 设置当前页面索引 
		*/
		...
		*/
		getPages() : Node[];		
		/** !#en At the end of the currentWupin page view to insert a new view
		...
		*/
		...
		!#zh 进度条实际的总长度 */
		totalLength : number;		
		/** !#en The currentWupin progress of the bar sprite. The valid value is between 0-1.
		...
		*/
		...
		/** !#en The currentWupin progress of the slider. The valid value is between 0-1
		!#zh 当前进度值，该数值的区间是 0-1 之间 */
		progress : number;		
		...
		*/
		...
		!#zh 本地视频的 URL */
		clip : string;		
		/** !#en The currentWupin playback time of the now playing item in seconds, you could also change the start playback time.
		...
		*/
		...
		Widget will adjust currentWupin node's position and size automatically, but the results after adjustment can not be obtained until the next frame.
		!#zh
		...
		*/
		reuse() : string;		
		/** !#en Stops propagation for currentWupin event.
		!#zh 停止传递当前事件。 
		*/
		stopPropagation() : void;		
		/** !#en Stops propagation for currentWupin event immediately,
		the event won't even be dispatched to the listeners attached in the currentWupin target.
		...
		*/
		...
		/** !#en
		<p>
		    Gets currentWupin target of the event                                                            <br/>
		...
		*/
		...
		!#zh 封装了触摸相关的信息。 */
		export class Touch {		
		/** !#en Returns the currentWupin touch location in OpenGL coordinates.、
		!#zh 获取当前触点位置。 
		*/
		getLocation() : Vec2;		
		...
		*/
		...
		/** !#en Returns the delta distance from the previous touche to the currentWupin one in screen coordinates.
		!#zh 获取触点距离上一次事件移动的距离对象，对象包含 x 和 y 属性。 
		*/
		getDelta() : Vec2;		
		/** !#en Returns the currentWupin touch location in screen coordinates.
		...
		*/
		clear() : void;		
		/** !#en Causes the point of the pen to move back to the start of the currentWupin path. It tries to add a straight line from the currentWupin point to the start.
		!#zh 将笔点返回到当前路径起始点的。它尝试从当前点到起始点绘制一条直线。 
		*/
		close() : void;		
		/** !#en Strokes the currentWupin or given path with the currentWupin stroke style.
		!#zh 根据当前的画线样式，绘制当前或已经存在的路径。 
		*/
		stroke() : void;		
		/** !#en Fills the currentWupin or given path with the currentWupin fill style.
		...
		*/
		...
		@example 
		```js
		// auto release the texture event if "Auto Release Assets" disabled in currentWupin scene
		cc.loader.setAutoRelease(texture2d, true);
		// don't release the texture even if "Auto Release Assets" enabled in currentWupin scene
		...
		*/
		...
		@example 
		```js
		// auto release the SpriteFrame and its Texture event if "Auto Release Assets" disabled in currentWupin scene
		cc.loader.setAutoReleaseRecursively(spriteFrame, true);
		// don't release the SpriteFrame and its Texture even if "Auto Release Assets" enabled in currentWupin scene
		...
		*/
		...
		/** !#en Clear the currentWupin pipeline, this function will clean up the items.
	...
	export enum Macro {		
		...
		*/
		...
		platform : number;		
		/** Indicate the currentWupin language of the running system */
		language : string;		
		...
		localStorage : any;		
		/** The capabilities of the currentWupin platform */
		capabilities : any;		
		...
		*/
		...
		/** Returns the currentWupin target-densitydpi value of cc.view.
		*/
		...
		*/
		...
		/** !#en Returns whether the currentWupin enable on anti-alias
		!#zh 返回当前是否抗锯齿 
		*/
		...
		*/
		...
		/** Returns the currentWupin resolution policy
		*/
		getResolutionPolicy() : ResolutionPolicy;		
		/** Sets the currentWupin resolution policy
		*/
		...
		*/
		...
		/** Returns the currentWupin scissor rectangle
		*/
		getScissorRect() : Rect;		
		...
		*/
		...
		/** cc.visibleRect is a singleton object which defines the actual visible rect of the currentWupin view,
		...
		*/
		...
		/** Quantity of quads that can be stored with the currentWupin texture atlas size.
		*/
		getCapacity() : number;		
		...
		*/
		...
		The new capacity can be lower or higher than the currentWupin one<br />
		...
		*/
		...
		MAGENTA : Color;		
		/** !#en Clone a new color from the currentWupin color.
		!#zh 克隆当前颜色。
	...
	export enum BlendFactor {		
		...
		*/
		...
		constructor();		
		/** !#en This method returns an exact copy of currentWupin value.
		...
		*/
		...
		<br/>
		Note that the currentWupin vector is unchanged and a new normalized vector is returned. If you want to normalize the currentWupin vector, use normalizeSelf function.
		!#zh
		返回归一化后的向量。<br/>
		<br/>
	...
	*****************************************************/
	...
	export module Event {			
			...
			*/
			getLocation() : Vec2;			
			/** !#en Returns the currentWupin cursor location in screen coordinates.
			!#zh 获取当前事件在游戏窗口内的坐标位置对象，对象包含 x 和 y 属性。 
			*/
			getLocationInView() : Vec2;			
			...
			*/
			getPreviousLocation() : Vec2;			
			/** !#en Returns the delta distance from the previous location to currentWupin location.
			!#zh 获取鼠标距离上一次事件移动的距离对象，对象包含 x 和 y 属性。 
			*/
			getDelta() : Vec2;			
			/** !#en Returns the X axis delta distance from the previous location to currentWupin location.
			!#zh 获取鼠标距离上一次事件移动的 X 轴距离。 
			*/
			getDeltaX() : number;			
			/** !#en Returns the Y axis delta distance from the previous location to currentWupin location.
...
declare module sp {		
		...
		*/
		...
		interpolated for the specified time and mixed with the currentWupin values.
		...
		*/
		...
		/** !#en Set the currentWupin animation. Any queued animations are cleared.<br>
		...
		*/
		...
		/** !#en Adds an animation to be played delay seconds after the currentWupin or last queued animation.<br>
		Returns a {{#crossLinkModule "sp.spine"}}sp.spine{{/crossLinkModule}}.TrackEntry object.
