...
cc.Class({
    ...
    onLoad: function () {
        ...
        self.txtable[0][0] = [cc.url.raw(self.info.txUrl + 'wushi1.jpg'),
        cc.url.raw(self.info.txUrl + 'wushi2.jpg'),
        cc.url.raw(self.info.txUrl + 'wushi3.jpg')];
        self.txtable[0][1] = [cc.url.raw(self.info.txUrl + 'wenren1.jpg'),
        cc.url.raw(self.info.txUrl + 'wenren2.jpg'),
        cc.url.raw(self.info.txUrl + 'wenren3.jpg')];
        self.txtable[0][2] = [cc.url.raw(self.info.txUrl + 'yishi1.jpg'),
        cc.url.raw(self.info.txUrl + 'yishi2.jpg'),
        cc.url.raw(self.info.txUrl + 'yishi3.jpg')];

        self.txtable[1][0] = [cc.url.raw(self.info.txUrl + 'wushinv1.jpg'),
        cc.url.raw(self.info.txUrl + 'wushinv2.jpg'),
        cc.url.raw(self.info.txUrl + 'wushinv3.jpg')];
        self.txtable[1][1] = [cc.url.raw(self.info.txUrl + 'wenrennv1.jpg'),
        cc.url.raw(self.info.txUrl + 'wenrennv2.jpg'),
        cc.url.raw(self.info.txUrl + 'wenrennv3.jpg')];
        self.txtable[1][2] = [cc.url.raw(self.info.txUrl + 'yishinv1.jpg'),
        cc.url.raw(self.info.txUrl + 'yishinv2.jpg'),
        cc.url.raw(self.info.txUrl + 'yishinv3.jpg')];
        cc.log(self.txtable);

    },
    /* 通过node.name获取按钮 */
    getComponentByNodeName: function (nodeName) {
        //cc.log(nodeName);
        //cc.log(typeName);
