...
cc.Class({
    ...
    // addMovePrefab:function(msg){
    //     cc.loader.loadRes('prefabs/move', cc.Prefab, function (err, prefab) {
    //         cc.log(err)
    //    // if (!err) {
    //         cc.find("Canvas/menuPanel/yidong").removeAllChildren();
    //         var movePrefab=cc.instantiate(prefab)
    //          var moveJs = movePrefab.getComponent('move');
    //          moveJs.init(msg);
    //         cc.find("Canvas/menuPanel/yidong").addChild(movePrefab);
    //    // }
    //        });
    // }
});
