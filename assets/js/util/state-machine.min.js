    ...
    function(t, n, i) {
        ...
        t.exports = {
            ...
            hook: function(t, n, i) {
                ...
                f = [t.context];
                for (i && (f = f.concat(i)), e = 0, s = a.length; e < s; e++) o = a[e],
                r = a[e][n],
                r && r.apply(o, f)
            }
        }
    ...
    function(t, n, i) {
        ...
        s(e.prototype, {
            ...
            addStateLifecycleNames: function(t) {
                this.lifecycle.onEnter[t] = r("on-enter-" + t),
                this.lifecycle.onLeave[t] = r("on-leave-" + t),
                this.lifecycle.on[t] = r("on-" + t)
            },
            ...
            addTransitionLifecycleNames: function(t) {
                this.lifecycle.onBefore[t] = r("on-before-" + t),
                this.lifecycle.onAfter[t] = r("on-after-" + t),
                this.lifecycle.on[t] = r("on-" + t)
            },
            ...
            configureInitTransition: function(t) {
                return "string" == typeof t ? this.mapTransition(s({},
                this.defaults.init, {
                    to: t,
                    active: !0
                })) : "object" == typeof t ? this.mapTransition(s({},
                this.defaults.init, t, {
                    active: !0
            ...
            configurePlugins: function(t, n) {
                t = t || [];
                var i, e, s;
                for (i = 0, e = t.length; i < e; i++) s = t[i],
    ...
    function(t, n, i) {
        ...
        s(e.prototype, {
            ...
            observersForEvent: function(t) {
                for (var n, i = 0,
                e = this.observers.length,
                s = []; i < e; i++) n = this.observers[i],
                n[t] && s.push(n);
                return [t, s, !0]
            },
            observeEvents: function(t, n, i) {
                ...
                s = t[0][1],
                r = t[0][2];
                if (n[0].event = e, e && r && e !== i && o.hook(this, "lifecycle", n), 0 === s.length) return t.shift(),
                this.observeEvents(t, n, e);
                var a = s.shift(),
                f = a[e].apply(a, n);
                return f && "function" == typeof f.then ? f.then(this.observeEvents.bind(this, t, n, e)).
                catch(this.endTransit.bind(this)) : f === !1 ? this.endTransit(!1) : this.observeEvents(t, n, e)
            },
